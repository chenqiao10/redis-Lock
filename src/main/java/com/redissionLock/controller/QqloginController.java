...
import com.qq.connect.oauth.Oauth;
	...
	public class QqloginController {
		...
		public String root(HttpServletRequest request){
			String result = "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>qq login</title></head><body><a href='http://127.0.0.1:9090/authorizeUrl'>qq第三方登陆</a><br><a href='http://wangfeifei.free.ngrok.cc/weixinlogin'>微信第三方登陆</a></body></html>";
			return result; 
		}
